        ...
        <form className='bg-white py-10 px-5 md:w-1/2 rounded-lg shadow' onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
                ...
                <input id='nombre' type="text" 
                       ...
                       placeholder='Nombre Del Proyecto' value={nombre} onChange={e => setNombre(e.target.value)}/>
            </div>
            ...
            <div className="mb-5">
                ...
                <textarea id='descripcion' type="text" 
                       className='border w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                       placeholder='Nombre Del Proyecto' value={descripcion} onChange={e => setDescripcion(e.target.value)}/>
            </div>
            ...
            <div className="mb-5">
                ...
                <input id='cliente' type="text" 
                       className='border w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                       placeholder='Nombre Del Proyecto' value={cliente} onChange={e => setCliente(e.target.value)}/>
            </div>

            <input type="submit" value={proyecto._id ? 'Actualizar Proyecto' : 'Crear Proyecto'} className="bg-sky-600 p-3 font-bold uppercase rounded cursor-pointer hover:bg-sky-700 transition-colors w-full text-white" />
